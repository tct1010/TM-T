...
namespace WatchStore.Areas.Admin.Controllers
{
    public class AuthController : Controller
    {
        ...
        {
            int count_username = db.Users.Where(m => m.Status == 1 && ((m.Phone).ToString() == User || m.Email == User || m.Name == User) && m.Access == 1).Count();
            ...
            else
            {
                ...
                /*access = 0 => admin, access = 1 => user*/
                /*String Password = Pass;*/
                var user_acount = db.Users
                .Where(m => m.Status == 1 && (m.Name == User && m.Password == Password) && m.Access == 1 );
